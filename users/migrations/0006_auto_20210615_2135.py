# Generated by Django 2.2.5 on 2021-06-16 04:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='language',
            field=models.CharField(blank=True, choices=[('en', 'English'), ('esp', 'Spanish')], default='en', max_length=2, verbose_name='language'),
        ),
    ]
